...
import cn.woyeshi.datePicker.adapter.AbstractWheelTextAdapter1;
 ...
 */
public class ChangeDatePopwindow extends Dialog implements View.OnClickListener {
    ...
    public ChangeDatePopwindow(final Context context, int style) {
        super(context, style);
        this.context = context;
        View view = View.inflate(context, cn.woyeshi.datePicker.R.layout.date_pick_dialog_myinfo_changebirth, null);
        wvYear = view.findViewById(cn.woyeshi.datePicker.R.id.wv_birth_year);
        wvMonth = view.findViewById(cn.woyeshi.datePicker.R.id.wv_birth_month);
        wvDay = view.findViewById(cn.woyeshi.datePicker.R.id.wv_birth_day);
        btnSure = view.findViewById(cn.woyeshi.datePicker.R.id.btn_myinfo_sure);
        btnCancel = view.findViewById(cn.woyeshi.datePicker.R.id.btn_myinfo_cancel);
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter1 {
        ...
        protected CalendarTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
            super(context, cn.woyeshi.datePicker.R.layout.date_pick_item_birth_year, NO_RESOURCE, currentItem, maxsize, minsize);
            this.list = list;
            setItemTextResource(cn.woyeshi.datePicker.R.id.tempValue);
        }
